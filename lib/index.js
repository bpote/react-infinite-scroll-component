...
/***/ (function(module, exports, __webpack_require__) {
	  ...
	  _createClass(InfiniteScroll, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      if (typeof this.props.initialScrollY === "number" && this.el.scrollHeight > this.props.initialScrollY) {
	        ...
	        this.isScrollDown() ? this.el.scrollTo(0, 0) : this.el.scrollTo(0, this.el.scrollHeight);
	      }
	    ...
	    value: function componentDidUpdate() {
	      if (!this.isScrollDown()) {
	        this.el.scrollTo(0, this.scrollTop + (this.el.scrollHeight - this.scrollHeight));
	      }
	    }
	  }, {
	    key: 'isScrollDown',
	    ...
	    key: 'isElementScrollPastThreshold',
	    value: function isElementScrollPastThreshold(target) {
	    ...
	    value: function onScrollListener(event) {
	      ...
	      var pastThreshold = this.isElementScrollPastThreshold(target, this.props.scrollThreshold);
	    ...
	    value: function render() {
	      ...
	      var outerDivStyle = this.props.pullDownToRefresh && this.props.height ? _extends({}, this.props.outerDivStyle, { overflow: 'auto' }) : this.props.outerDivStyle;
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          !this.isScrollDown() && !this.state.showLoader && !hasChildren && this.props.hasMore && this.props.loader,
	          !this.isScrollDown() && this.state.showLoader && this.props.hasMore && this.props.loader,
	          this.props.children,
	          this.isScrollDown() && !this.state.showLoader && !hasChildren && this.props.hasMore && this.props.loader,
	          this.isScrollDown() && this.state.showLoader && this.props.hasMore && this.props.loader,
	...
	InfiniteScroll.propTypes = {
	  ...
	  outerDivStyle: _propTypes2['default'].object
	};
